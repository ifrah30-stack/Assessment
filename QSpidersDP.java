...
public class QSpidersDP {
	public static void main(String[] args) throws InterruptedException {
        ...
        nextMonth.click();
        WebElement date10 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'react-datepicker_day--010') and not(contains(@class,'react-datepicker_day--outside-month'))]")));
        date10.click();
        wait.until(driver1 -> {
